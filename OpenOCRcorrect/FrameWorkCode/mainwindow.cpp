...
void MainWindow::on_actionBold_triggered()
{
    ...
    ui->textBrowser->mergeCurrentCharFormat(font);
}
...
void MainWindow::on_actionSuperscript_triggered()
{
    ...
    ui->textBrowser->insertHtml(QString("<sup>%1</sup>").arg(selected_text));
}
...
void MainWindow::on_actionSubscript_triggered()
{
    ...
    QString selected_text = cursor.selectedText();
    ui->textBrowser->textCursor().removeSelectedText();
    ui->textBrowser->insertHtml(QString("<sub>%1</sub>").arg(selected_text));
}
